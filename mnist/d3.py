...
LOGDIR = "D:\迅雷下载\深度学习1\mnist_手写识别tensorflow\MNIST_data"
...
def mnist():
    ...
    mnist = input_data.read_data_sets(train_dir="D:\迅雷下载\深度学习1\mnist_手写识别tensorflow\MNIST_data", one_hot=True)
